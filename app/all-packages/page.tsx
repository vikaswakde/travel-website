      ...
      <div className="container mx-auto px-4">
        <div className="mb-12">
          ...
          <p className="text-gray-600">
            Browse through our complete collection of travel packages
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {packages?.map((pkg) => (
            <div
              key={pkg.id}
              className=" rounded-xl overflow-hidden flex flex-col shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <div className="relative">
                ...
                />
                <div className="absolute top-4 right-4 bg-neutral-200 rounded-full py-1 px-3">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <a
                      href={`https://wa.me/1234567890?text=I'm interested in ${pkg.name} package`}
                      target="_blank"
